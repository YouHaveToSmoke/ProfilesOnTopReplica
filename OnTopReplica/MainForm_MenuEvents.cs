...
namespace OnTopReplica {
    partial class MainForm {
        ...
        private void Menu_opening(object sender, CancelEventArgs e) {
            ...
            cloneWindowToolStripMenuItem.Enabled = showing;
        ...
        private void Menu_SaveProfile_click(object sender, EventArgs e) {
            ShowSaveProfileDialog();
        }

        private void Menu_LoadProfile_click(object sender, EventArgs e) {
            ShowLoadProfileDialog();
        }

        private void Menu_ManageProfiles_click(object sender, EventArgs e) {
            ShowManageProfilesDialog();
        }

        private void Menu_AddRegionToProfile_click(object sender, EventArgs e) {
            ShowAddRegionToExistingProfileDialog();
        }

        private void Menu_SaveAllInstances_click(object sender, EventArgs e) {
            ShowSaveAllInstancesDialog();
        }

        private void Menu_CloneWindow_click(object sender, EventArgs e) {
            CloneCurrentWindow();
        }
