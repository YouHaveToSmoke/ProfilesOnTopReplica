...
namespace OnTopReplica.Native {
    ...
    static class WindowMethods {
        ...
        /// <returns>Size of the client area, or Size.Empty if failed.</returns>
        ...
        /// <summary>
        /// Gets the window rectangle (position and size on screen).
        /// </summary>
        /// <param name="hwnd">Window handle.</param>
        /// <returns>Rectangle of the window, or Rectangle.Empty if failed.</returns>
